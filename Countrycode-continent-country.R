...
# Correction pour Micronesia mal affiché selon country code après essaie
détecte_micronesia <-données$country== "micronesia"
données$country[détecte_micronesia] <-"Micronesia, Federated States of"

# Uniformisation des pays
pays_uniformisés <-countrycode(données$country,"country.name","country.name")
...
données$continent <-countrycode(données$country,"country.name","continent",custom_match=correction_continent)
