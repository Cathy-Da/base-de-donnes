...
labs(title="Carte mondiale des catastrophes naturelles de 1960 à 2018",
...
labs(title="Catastrophes naturelles par type de 1960 à 2018",
caption=paste("Source: nasa_disaster_correction.csv\nTotal d’événements:",
...
cat("Nombre total d’événements:", nrow(base_de_donnees),"\n")
